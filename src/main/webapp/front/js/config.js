...
var centerMenu = [
    ...
    ,{
        name: '备考课程预定',
        url: '../beikaokechengOrder/list.jsp'
    }
    ,{
        name: '在职培训课程预定',
        url: '../zaizhikechengOrder/list.jsp'
    }
...
var indexNav = [
    ...
    {
        name: '备考课程',
        url: './pages/beikaokecheng/list.jsp'
    },
    {
        name: '讲师',
        url: './pages/jiangshi/list.jsp'
    },
    {
        name: '公告',
    ...
    {
        name: '在职培训课程',
        url: './pages/zaizhikecheng/list.jsp'
    },

]

var adminurl =  "http://localhost:8080/gongwuyuanpeixun/index.jsp";
