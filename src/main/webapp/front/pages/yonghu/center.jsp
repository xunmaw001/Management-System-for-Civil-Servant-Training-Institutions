				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="yonghuName" id="yonghuName" lay-verify="required" placeholder="考生姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="yonghuXuexiao" id="yonghuXuexiao" lay-verify="required" placeholder="学校" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="yonghuZhuanye" id="yonghuZhuanye" lay-verify="required" placeholder="专业" autocomplete="off" class="layui-input">
							</div>
						</div>
			<div class="layui-form-item">
