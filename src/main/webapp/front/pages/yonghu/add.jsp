    ...
    <div class="data-add-container">
        ...
        <form class="layui-form layui-form-pane" lay-filter="myForm">
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input v-model="detail.yonghuName" type="text" name="yonghuName" id="yonghuName" placeholder="考生姓名" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
...
<!-- 身份证号 -->
        ...
        <!-- 手机号 -->
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input v-model="detail.yonghuXuexiao" type="text" name="yonghuXuexiao" id="yonghuXuexiao" placeholder="学校" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input v-model="detail.yonghuZhuanye" type="text" name="yonghuZhuanye" id="yonghuZhuanye" placeholder="专业" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
