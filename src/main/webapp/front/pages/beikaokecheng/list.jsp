                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="beikaokechengName" id="beikaokechengName" placeholder="课程名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../beikaokecheng/detail.jsp?id='+item.id)">
                                    <a href="#" class="ng-prsliik">
                                        <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                            <img class="swiper-item" :src="item.beikaokechengPhoto?item.beikaokechengPhoto.split(',')[0]:''" />
                                        </span>
                                ...
                                <div class="ng-prslist-tit" @click="jump('../beikaokecheng/detail.jsp?id='+item.id)"><span>{{item.beikaokechengName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 beikaokechengContent 字段去除无用字符 如果字段长度大于60  就截取到60
            beikaokechengContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#beikaokechengName').val() != null && jquery('#beikaokechengName').val() != "" && jquery('#beikaokechengName').val() != "null" ) {
                param['beikaokechengName'] = jquery('#beikaokechengName').val();
            }
                                    // 获取列表数据
            http.request('beikaokecheng/list', 'get', param, function(res) {
