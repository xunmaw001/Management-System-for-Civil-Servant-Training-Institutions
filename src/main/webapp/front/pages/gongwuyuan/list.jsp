            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">在职公务员展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="gongwuyuanName" id="gongwuyuanName" placeholder="公务员姓名" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="gongwuyuanIdNumber" id="gongwuyuanIdNumber" placeholder="身份证号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="gongwuyuanPhone" id="gongwuyuanPhone" placeholder="手机号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <select name="gongwuyuanTypes" id="gongwuyuanTypes" lay-filter="gongwuyuanTypes">
                                  ...
                                  <option v-for="item in gongwuyuanTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 gongwuyuanContent 字段去除无用字符 如果字段长度大于60  就截取到60
            gongwuyuanContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#gongwuyuanName').val() != null && jquery('#gongwuyuanName').val() != "" && jquery('#gongwuyuanName').val() != "null" ) {
                param['gongwuyuanName'] = jquery('#gongwuyuanName').val();
            }
         
            if (jquery('#gongwuyuanIdNumber').val() != null && jquery('#gongwuyuanIdNumber').val() != "" && jquery('#gongwuyuanIdNumber').val() != "null" ) {
                param['gongwuyuanIdNumber'] = jquery('#gongwuyuanIdNumber').val();
            }
     
            if (jquery('#gongwuyuanPhone').val() != null && jquery('#gongwuyuanPhone').val() != "" && jquery('#gongwuyuanPhone').val() != "null" ) {
                param['gongwuyuanPhone'] = jquery('#gongwuyuanPhone').val();
            }
         
            var gongwuyuanTypes = $("#gongwuyuanTypes").find("option:selected").val();
            if (gongwuyuanTypes != null && gongwuyuanTypes != "" && gongwuyuanTypes != "null") {
                param['gongwuyuanTypes'] = gongwuyuanTypes;
            }
                    // 获取列表数据
            http.request('gongwuyuan/list', 'get', param, function(res) {
...
// 当前表的字典表
       ...
       function gongwuyuanTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=gongwuyuan_types", 'get', {}, function (res) {
               if(res.code == 0){
