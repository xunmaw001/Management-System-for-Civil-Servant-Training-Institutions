                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="zaizhikechengName" id="zaizhikechengName" placeholder="课程名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <select name="zaizhikechengTypes" id="zaizhikechengTypes" lay-filter="zaizhikechengTypes">
                                  ...
                                  <option v-for="item in zaizhikechengTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../zaizhikecheng/detail.jsp?id='+item.id)">
                                    <a href="#" class="ng-prsliik">
                                        <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                            <img class="swiper-item" :src="item.zaizhikechengPhoto?item.zaizhikechengPhoto.split(',')[0]:''" />
                                        </span>
                                ...
                                <div class="ng-prslist-tit" @click="jump('../zaizhikecheng/detail.jsp?id='+item.id)"><span>{{item.zaizhikechengName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 zaizhikechengContent 字段去除无用字符 如果字段长度大于60  就截取到60
            zaizhikechengContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#zaizhikechengName').val() != null && jquery('#zaizhikechengName').val() != "" && jquery('#zaizhikechengName').val() != "null" ) {
                param['zaizhikechengName'] = jquery('#zaizhikechengName').val();
            }
         
            var zaizhikechengTypes = $("#zaizhikechengTypes").find("option:selected").val();
            if (zaizhikechengTypes != null && zaizhikechengTypes != "" && zaizhikechengTypes != "null") {
                param['zaizhikechengTypes'] = zaizhikechengTypes;
            }
                                // 获取列表数据
            http.request('zaizhikecheng/list', 'get', param, function(res) {
...
// 当前表的字典表
       ...
       function zaizhikechengTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=zaizhikecheng_types", 'get', {}, function (res) {
               if(res.code == 0){
