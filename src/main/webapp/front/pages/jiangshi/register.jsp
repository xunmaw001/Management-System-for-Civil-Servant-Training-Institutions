              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">讲师名称:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="jiangshiName" id="jiangshiName"  placeholder="讲师名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">讲师性别:</span>
                        <div class="layui-input-inline">
...
<!-- 手机号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">讲师联系方式:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="jiangshiPhone" id="jiangshiPhone"  lay-verify="phone|required"   placeholder="讲师联系方式" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
