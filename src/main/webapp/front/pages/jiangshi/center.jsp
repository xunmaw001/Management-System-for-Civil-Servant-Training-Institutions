	...
	<body style="background: #EEEEEE;">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="jiangshiName" id="jiangshiName" lay-verify="required" placeholder="讲师名称" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="jiangshiPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="jiangshiPhoto" name="jiangshiPhoto"/>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="jiangshiPhone" id="jiangshiPhone"  lay-verify="required|phone"   placeholder="讲师联系方式" autocomplete="off" class="layui-input">
							</div>
						</div>
			<div class="layui-form-item">
                <div class="layui-block">
                    ...
                    <div class="layui-input-block">
                        <input type="text" value="0" readonly name="jiangshiMoney" id="jiangshiMoney"  lay-verify="required|double"   placeholder="讲师薪资" autocomplete="off" class="layui-input">
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload'], function () {
                ...
                http.request(`jiangshi/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#jiangshiPhotoImg").attr("src", data.data.jiangshiPhoto);
                });
