                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="jiangshiName" id="jiangshiName" placeholder="讲师名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../jiangshi/detail.jsp?id='+item.id)">
                                    <a href="#" class="ng-prsliik">
                                        <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                            <img class="swiper-item" :src="item.jiangshiPhoto?item.jiangshiPhoto.split(',')[0]:''" />
                                        </span>
                                ...
                                <div class="ng-prslist-tit" @click="jump('../jiangshi/detail.jsp?id='+item.id)"><span>{{item.jiangshiName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 jiangshiContent 字段去除无用字符 如果字段长度大于60  就截取到60
            jiangshiContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#jiangshiName').val() != null && jquery('#jiangshiName').val() != "" && jquery('#jiangshiName').val() != "null" ) {
                param['jiangshiName'] = jquery('#jiangshiName').val();
            }
            ...
            if (sexTypes != null && sexTypes != "" && sexTypes != "null") {
                param['sexTypes'] = sexTypes;
                                ...
                                // 获取列表数据
            http.request('jiangshi/list', 'get', param, function(res) {
