            ...
            <form class="layui-form login-form">
              ...
              <div class="layui-form-item input">
                <div class="layui-input-block" style="text-align: left;margin-left: 0;">
                  <input type="radio" name="role"  value="yonghu" title="考生">
                  <input type="radio" name="role"  value="gongwuyuan" title="在职公务员">
                </div>
              </div>
              ...
              <a class="bottom-text-w3ls" href="javascript:registerClick('yonghu')">注册考生</a>
              <a class="bottom-text-w3ls" href="javascript:registerClick('gongwuyuan')">注册在职公务员</a>
            </form>
          </article>
        </div>
      </div>
