...
public class ZaizhikechengOrderEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ZaizhikechengOrderEntity() {

	}

	public ZaizhikechengOrderEntity(T t) {
		try {
    ...
    public String toString() {
        return "ZaizhikechengOrder{" +
            "id=" + id +
            ", yonghuId=" + yonghuId +
            ", zaizhikechengId=" + zaizhikechengId +
