...
public class BeikaokechengView extends BeikaokechengEntity implements Serializable {
	...
	public BeikaokechengView() {

	}

	public BeikaokechengView(BeikaokechengEntity beikaokechengEntity) {
		try {
			BeanUtils.copyProperties(this, beikaokechengEntity);
